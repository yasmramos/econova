 ...
 * 
 * <p>Argon2 es el ganador del concurso de funciones de hash de contraseña Password Hashing Competition (PHC)
 * y proporciona una excelente resistencia contra ataques de fuerza bruta y side-channel.</p>
 * 
 ...
 *   <li><strong>Tipo:</strong> Argon2id - Combina las ventajas de Argon2i y Argon2d</li>
 * </ul>
 * 
...
public class Argon2PasswordHasher implements PasswordHasher {
    ...
    /**
     * Número de iteraciones para el algoritmo Argon2.
     * Mayor valor = más seguro pero más lento.
     */
    private static final int ITERATIONS = 3;
    
    /**
     * Cantidad de memoria en KB a utilizar (64MB).
     * Mayor valor = más resistente a ataques de hardware especializado.
     */
    private static final int MEMORY = 65536; // 64MB
    
    /**
     * Grado de paralelismo para el cálculo.
     * Permite aprovechar múltiples núcleos de CPU.
     */
     ...
     * 
     * <p>Argon2id combina las ventajas de Argon2i (resistencia a side-channel attacks)
     * y Argon2d (resistencia a GPU cracking) tomando características de ambos.</p>
     */
     ...
     * 
     * <p>Este método es la implementación preferida ya que:
     * <ul>
     ...
     * </p>
     * 
     * <p>El hash generado incluye todos los parámetros de configuración y salt,
     * por lo que la verificación posterior no requiere almacenar información adicional.</p>
     * 
    ...
    public String hash(char[] password) {
        ...
        try {
            ...
            // Clear the password array immediately after use to prevent it from
    ...
    /**
     * Verifica si una contraseña en texto plano corresponde a un hash Argon2 dado.
     * 
     * <p>Este método es resistente a ataques timing ya que Argon2 realiza
     * comparaciones de hashes de forma segura.</p>
     * 
     * @param hash Hash Argon2 almacenado previamente (no null)
     * @param rawPassword Array de caracteres con la contraseña a verificar (no null)
    ...
    public boolean verify(String hash, char[] rawPassword) {
        ...
        try {
            ...
            // Clear the password array immediately after use for security
     ...
     * {@inheritDoc}
     * 
     * <p><strong>Advertencia:</strong> Este método convierte el String a char[]
     * lo que puede dejar copias de la contraseña en el String pool de Java.
     * Se recomienda usar {@link #hash(char[])} cuando sea posible.</p>
     * 
    ...
    public String hash(String password) {
        ...
        try {
            ...
            // Clear the temporary char array to enhance security
            Arrays.fill(chars, '\0');
        }
    }
     ...
     * <p><strong>Advertencia:</strong> Este método convierte el String a char[]
     * lo que puede dejar copias de la contraseña en el String pool de Java.
     * Se recomienda usar {@link #verify(String, char[])} cuando sea posible.</p>
     * 
    ...
    public boolean verify(String hash, String rawPassword) {
        ...
        try {
            ...
            // Clear the temporary char array for better security
            Arrays.fill(chars, '\0');
        }
    }
