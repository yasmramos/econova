 ...
 *
 * <p>
 * Esta interfaz sigue el principio de inversión de dependencias y permite
 * diferentes implementaciones (BCrypt, PBKDF2, Argon2, etc.) sin cambiar el
 * código cliente.</p>
 *
 * <p>
...
public interface PasswordHasher {
     ...
     *
     * <p>
     * Este método debe ser determinista para verificación posterior y
     * generalmente incluye un salt aleatorio para prevenir ataques de
     * diccionario y rainbow tables.</p>
     *
     ...
     *
     * <p>
     * Este método debe ser resistente a ataques timing (timing attacks)
    ...
    boolean verify(String hash, char[] rawPassword);
}
