...
public class Card extends JPanel {
    ...
    private static final long serialVersionUID = 7221082364218961842L;
    ...
    private JPanel createHeader() {
        ...
        header.putClientProperty(FlatClientProperties.STYLE, "" +
                "background:null");
        JLabel label = new JLabel("Contabilidad");
        header.add(label);
        return header;
    }
    ...
    private JPanel createBody() {
        ...
        body.putClientProperty(FlatClientProperties.STYLE, "" +
                "background:null");
        JLabel title = new JLabel("Cuerpo del Card Component");
        ...
        description.setText("Texto de Prueba");
