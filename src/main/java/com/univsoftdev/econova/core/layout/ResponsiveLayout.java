package com.univsoftdev.econova.core.layout;
...
public class ResponsiveLayout implements LayoutManager {
    ...
    public Dimension preferredLayoutSize(Container parent) {
        synchronized (parent.getTreeLock()) {
            ...
            int col = getColumn(parent, itemSize.width, count);
            if (count == 0) {
            ...
            width += col * itemSize.width + ((col - 1) * hGap);
    ...
    public void layoutContainer(Container parent) {
        synchronized (parent.getTreeLock()) {
            ...
            int col = getColumn(parent, itemSize.width, count);
            LayoutOption layoutOption = getLayoutOption(itemSize, width, col);
    ...
    private LayoutOption getLayoutOption(Dimension itemSize, int width, int column) {
        ...
        int hGap = h;
        int vGap = v;
        if (null != justifyContent) switch (justifyContent) {
            case FIT_CONTENT:
