...
public class CurvesPanel extends GradientPanel {
    ...
    @Serial
    private static final long serialVersionUID = -1885055695759945128L;
    ...
    public CurvesPanel() {
        ...
        super(Color.decode("#052659"), Color.decode("#434343"));
    ...
    private void drawCurve(@NotNull Graphics2D g2,
