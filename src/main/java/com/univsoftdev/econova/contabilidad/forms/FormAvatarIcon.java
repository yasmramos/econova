...
import com.univsoftdev.econova.contabilidad.component.AvatarBorderColorIcon;
...
public class FormAvatarIcon extends Form {
    ...
    private @NotNull JPanel createInfo() {
    ...
    private @NotNull Component createOptions() {
    ...
    private @NotNull Component createOption() {
    ...
    private @NotNull Component createBorderOption() {
    ...
    private @NotNull Component createExample() {
    ...
    private @NotNull Component createColors(AvatarIcon.BorderColor @NotNull [] borderColors, boolean gradient) {
