...
import com.univsoftdev.econova.core.simple.SimpleCustomToast;
...
import raven.modal.toast.option.ToastBorderStyle.BorderType;

public class FormToast extends Form {

    private static final long serialVersionUID = -2870287437341888546L;
    ...
    private ToastOption getSelectedOption() {
        ...
        ToastBorderStyle borderStyle = ToastStyle.getDefault().getBorderStyle();
        ToastBorderStyle.BorderType borderType = borderStyle.getBorderType();
        borderType = jrBorderOutline.isSelected() ? BorderType.OUTLINE : jrBorderRightLine.isSelected() ? BorderType.TRAILING_LINE : jrBorderLeftLine.isSelected() ? BorderType.LEADING_LINE : jrBorderTopLine.isSelected() ? BorderType.TOP_LINE : jrBorderBottomLine.isSelected() ? BorderType.BOTTOM_LINE : BorderType.NONE;
