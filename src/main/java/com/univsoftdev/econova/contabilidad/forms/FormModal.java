...
import com.univsoftdev.econova.core.simple.SimpleInputForms2;
...
public class FormModal extends Form {
    ...
    private static final long serialVersionUID = -45419223476777490L;
    ...
    private Option getSelectedOption() {
        ...
        option.getBorderOption()
                .setBorderWidth((int) (chBorder.isSelected() ? 1f : 0))
